...
async function action4({ request: request2 }) {
  ...
  return console.log(data), data === void 0 ? (0, import_node8.json)({ message: "Can't find province" }) : (0, import_node8.redirect)(`/analystics/${data.codename}`);
}
