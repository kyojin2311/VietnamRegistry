import ExpiredSoonProvinceTable from "../components/Analystics/ExpiredSoonProvince";
import { requireUserSession } from "../services/auth.server";
import provincedata from "../util/province.json";
export default function ProvinceExpiredSoon() {
  return <ExpiredSoonProvinceTable />;
}
