      ...
      <Form method="post">
        ...
        <div className="relative z-0 w-3/4 mb-6 group">
          ...
          <select
            name="city"
            id="city"
            className="block py-2.5 px-0 w-3/4 text-sm text-gray-900 dark:bg-gray-800 border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer "
          >
            {option}
          </select>
        </div>
