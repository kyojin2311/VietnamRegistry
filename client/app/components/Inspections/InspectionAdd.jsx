...
export default function InspectionsAddForm(props) {
  ...
  return (
    <Form method="post">
      {actionData && (
        <div className="dark:text-red-500 dark:font-bold dark:text-xl">
          {actionData.message}
        </div>
      )}
      <div>
      ...
      <div>
        <ol className="flex items-center justify-self-center w-full p-3 space-x-2 text-sm font-medium text-center text-primary-700 bg-white border border-green-400 rounded-lg shadow-sm dark:text-green-300 sm:text-base dark:bg-gray-800 dark:border-gray-700 sm:p-4 sm:space-x-4 mt-6">
