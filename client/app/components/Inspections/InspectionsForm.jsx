...
export default function InspectionsForm({ data }) {
  return (
    <section className="text-gray-600 body-font dark:text-white m-auto dark:bg-slate-800 rounded-lg">
      ...
      <div className="container px-5 py-24 mx-auto">
        <div className="flex flex-wrap -mx-4 -mb-10 text-center">
          ...
          <div className="lg:w-1/2 mb-10 px-4">
            <section className="m-4">
              ...
              <div className="text-left flex w-full mt-1">
                ...
                <div className="flex-1">
                  Số quản lý: {data.car.certificate.certNum}
                </div>
              </div>
            ...
            <section className="m-4">
              ...
              <div className="text-left  w-full mt-1">
                ...
                <div className="block w-full">
                  {data.car.specification.luggageContainer}
                </div>
              </div>
              <div className="text-left  w-full mt-1">
                Chiều dài cơ sở:
          ...
          <div className="lg:w-1/2 mb-10 px-4">
            <section className="m-4">
              ...
              <div className="text-left  w-full mt-1">
                ...
                <div className="block w-full italic text-sm">
                  (Permission No. of Pers Carried: seat, stood place, laying
                  place)
                </div>
              </div>
              <div className="text-left  w-full mt-1">
              ...
              <div className="container flex flex-wrap mx-auto items-center pt-3">
                ...
                <div className="flex-initial w-2/3">
                  <div className="text-center  w-full mt-1">
                    {data.regisPlace.city}, {formatDate(data.regisDate)}
                  </div>
                  ...
                  <div>
                    ...
                    <div className="mt-3 dark:text-red-700 text-center font-medium block">
                      {data.regisPlace.name}
                    </div>
                  </div>
                </div>
              </div>
